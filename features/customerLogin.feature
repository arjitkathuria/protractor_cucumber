...
Feature: Test customer login, logout, deposit, deposit and negative scenario of XYZ bank
    ...
    @depositAndWithdrawlTestCase @negative
    Scenario Outline: Verify the deposit and withdrawl functionality of XYZ bank
        ...
        Examples:
            ...
            | 'Hermoine Granger' | 'withdrawl' | 'text on withdrawl' | '9000' | 'withdrawl section' | 'withdrawl button' | 'Transaction Failed. You can not withdraw amount more than the balance.' | 'withdrawl screen error' |